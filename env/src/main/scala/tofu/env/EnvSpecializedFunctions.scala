...
trait EnvSpecializedFunctions[E] {
  ...
  def parMap4[A1, A2, A3, A4, R](fa1: Env[E, A1], fa2: Env[E, A2], fa3: Env[E, A3], fa4: Env[E, A4])(
      f: (A1, A2, A3, A4) => R): Env[E, R] = Env.parMap4(fa1, fa2, fa3, fa4)(f)

  def parMap5[A1, A2, A3, A4, A5, R](fa1: Env[E, A1],
                                     fa2: Env[E, A2],
                                     fa3: Env[E, A3],
                                     fa4: Env[E, A4],
  ...
  def parMap6[A1, A2, A3, A4, A5, A6, R](fa1: Env[E, A1],
                                         fa2: Env[E, A2],
                                         fa3: Env[E, A3],
                                         fa4: Env[E, A4],
                                         fa5: Env[E, A5],
  ...
  def map6[A1, A2, A3, A4, A5, A6, R](fa1: Env[E, A1],
                                      fa2: Env[E, A2],
                                      fa3: Env[E, A3],
                                      fa4: Env[E, A4],
                                      fa5: Env[E, A5],
