...
trait LoggedValue {
  ...
  def logFields[I, V, @specialized(Unit) R, @specialized M](input: I)(implicit r: LogRenderer[I, V, R, M]): R
...
object LoggedValue {
  implicit val loggable: Loggable[LoggedValue] = new Loggable[LoggedValue] {
    def fields[I, V, @specialized(Unit) R, M](a: LoggedValue, input: I)(implicit receiver: LogRenderer[I, V, R, M]): R =
      a.logFields(input)
...
final class LoggedThrowable(cause: Throwable) extends Throwable(cause.getMessage, cause) with LoggedValue {
  ...
  def logFields[I, V, @specialized(Unit) R, @specialized M](input: I)(implicit f: LogRenderer[I, V, R, M]): R =
