...
sealed trait CalcM[+F[+_, +_], -R, -SI, +SO, +E, +A] extends CalcMOps[F, R, SI, SO, E, A] {
  def mapK[G[+_, +_]](fk: F FunBK G): CalcM[G, R, SI, SO, E, A]
...
object CalcM extends CalcMInstances {
  ...
  sealed trait CalcMRes[-R, -S1, +S2, +E, +A] extends CalcM[Nothing, R, S1, S2, E, A] {
    ...
    def mapK[G[+_, +_]](fk: Nothing FunBK G): CalcM[G, R, S1, S2, E, A] = this
  }
  ...
  final case class Defer[+F[+_, +_], -R, -S1, +S2, +E, +A](runStep: () => CalcM[F, R, S1, S2, E, A])
    ...
    def mapK[G[+_, +_]](fk: F FunBK G): CalcM[G, R, S1, S2, E, A] = Defer(() => runStep().mapK(fk))
  ...
  final case class Provide[+F[+_, +_], R, -S1, +S2, +E, +A](r: R, inner: CalcM[F, R, S1, S2, E, A])
    ...
    type R1 = R
    def any                                                         = Is.refl
    def mapK[G[+_, +_]](fk: F FunBK G): CalcM[G, Any, S1, S2, E, A] = Provide(r, inner.mapK(fk))
  ...
  object Sub {
    ...
    def apply[F[+_, +_], S, E, A](fa: F[E, A]): CalcM[F, Any, S, S, E, A] = new Sub[F, S, S, E, A](fa) {
      ...
      def mapK[G[+_, +_]](fk: F FunBK G): CalcM[G, Any, S, S, E, A] = Sub(fk(fa))
    }
  }
  ...
  final case class Bound[+F[+_, +_], R, S1, S2, S3, E1, E2, A, B](
    ...
    def mapK[G[+_, +_]](fk: F FunBK G): CalcM[G, R, S1, S3, E2, B] =
      Bound(
        src.mapK(fk),
