...
object MovingCompany extends Logging.Companion[MovingCompany] {
  def make[F[_]: Monad: Log: Logging.Make]: MovingCompany[F] = new MovingCompany[F] {
...
object Warehouse extends Logging.Companion[Warehouse] {
  def makeSmall[F[_]: Monad: Log: Logging.Make]: Warehouse[F] = new Warehouse[F] {
